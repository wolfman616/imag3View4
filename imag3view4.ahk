...
Varz:
global hgui,RECT,Xcret10nnit,Image_Title,ImagePath,x10n,CURRENT_H,CURRENT_W,Pwner,opt_allCenter,pic_arr,Options,Curr_i,hovered,OWin,OControl,hGui,hovered,RECT,mdc,lbutton_click_thresh,rbutton_cooldown,turds,Curr_i,Starting_file,OutNameNoExt,_i_ndx_,Max_i,Curr_iOLD1,Curr_iOLD2,Options,pic0,pic1,pic2,xcent,ycent,repent,hi,wi,Recurse,opt_MaxFill,opt_ShrinkFill,alignment,ren,hovered,keys,r3gk3y,ID_VIEW_VARIABLES:=65407,ID_TRAY_EDITSCRIPT:=65304,ID_TRAY_SUSPEND:=65305,ID_TRAY_PAUSE:=65306.ID_TRAY_EXIT:=65307,ID_TRAY_RELOADSCRIPT:=65303,_nx:=0,_ny:=0,_Netnx:=0,_Netny:=0,netnxold,netnyold,netxt,netyTemp,netx,nety,opt_Anchor,ftypes,keys,sometrigger
